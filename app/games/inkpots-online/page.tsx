...
export default function InkpotsOnlineLobby() {
  ...
  const handleCreateGame = () => {
    ...
    router.push(`/games/inkpots-online/${gameId}?host=true`);
  };

  const handleJoinGame = () => {
    if (gameIdInput.trim()) {
      router.push(`/games/inkpots-online/${gameIdInput.trim()}?host=false`);
    }
  };
          ...
          <div className="space-y-4 mb-8">
            <div className="bg-blue-50 dark:bg-blue-950 border-2 border-blue-300 dark:border-blue-700 rounded-lg p-4">
              ...
              <ul className="text-left space-y-1 text-gray-700 dark:text-gray-300">
                <li>• Draft letters from random choices (3 options per pick)</li>
                <li>• Form words to earn coins and fill your book</li>
                <li>• Buy items from the shop to gain advantages</li>
                <li>• First player to write 50 letters wins!</li>
                <li>• Use items strategically to help yourself or hinder your opponent</li>
              </ul>
            </div>
